...
import { FaSearch, FaLeaf, FaTimes } from 'react-icons/fa';
               ...
               <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
                  ...
                  <div className='flex items-center gap-2 w-full md:max-w-md'>
                     ...
                     <button
                        ...
                        className={`cursor-pointer flex items-center justify-center gap-2 px-4 py-2 rounded-full border text-sm font-medium transition-all whitespace-nowrap shrink-0 ${isVegOnly
